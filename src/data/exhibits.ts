...
const seeds: Seed[] = [
  ...
  },
  {
    ...
    images: [
      { url: '/exhibits/series6/img-render-1.png', title: '全集封面·八桂采鲜亲子同欢', ratio: 1646 / 2103 },
      { url: '/exhibits/series6/img-01.jpeg', title: '“南”得亲子乐（南瓜定稿）', ratio: 1664 / 2496 },
      ...
      { url: '/exhibits/series6/img-render-6.png', title: '蔗甜情深（甘蔗定稿）', ratio: 1646 / 2007 },
  ...
  },
  {
    ...
    images: [
      { url: '/exhibits/series5/img-01.jpeg', title: '芒了个果（芒果·方案一）', ratio: 1072 / 1516 },
      { url: '/exhibits/series5/img-02.jpeg', title: '芒了个果（芒果·方案二）', ratio: 1138 / 1517 },
      { url: '/exhibits/series5/img-03.jpeg', title: '荔质洋溢（荔枝·方案一）', ratio: 1138 / 1517 },
      { url: '/exhibits/series5/img-04.jpeg', title: '荔质洋溢（荔枝·方案二）', ratio: 1138 / 1517 },
      { url: '/exhibits/series5/img-05.jpeg', title: '柑橘正好（沃柑·方案一）', ratio: 1138 / 1517 },
      { url: '/exhibits/series5/img-06.jpeg', title: '柑橘正好（沃柑·方案二）', ratio: 1138 / 1517 },
      { url: '/exhibits/series5/img-07.jpeg', title: '柿柿如意 · 百香百味', description: '柿子与百香果篇。', ratio: 1024 / 1820 },
    ],
  },
  {
    id: 'series-2',
